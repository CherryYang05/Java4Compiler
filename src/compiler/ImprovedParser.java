...
public class ImprovedParser {
    ...
    public void statements() {
        ...
        //expression();
        //
        //if (lexer.match(compiler.Lexer.SEMI)) {
        //    /*
        ...
        //}
        //
        //if (!lexer.match(compiler.Lexer.EOI)) {
        //    /*
        //     * 分号后还有字符，继续解析
        //     */
        //    statements();
     ...
     * 由于当 lexer.match(compiler.Lexer.PLUS)判断成立时，expr_prime()有递归调用
     */
    //private void expr_prime() {
    //    /*
    //     * expression' -> PLUS term expression' | '空'
    //     */
    //    if (lexer.match(compiler.Lexer.PLUS)) {
    //        lexer.advance();
    //        term();
    //        expr_prime();
    //    } else if (lexer.match(compiler.Lexer.UNKNOWN_SYMBOL)) {
    //        isLegalStatement = false;
    ...
    //     * term' -> * factor term' | '空'
    //     */
    //    if (lexer.match(compiler.Lexer.TIMES)) {
    //        lexer.advance();
    //        factor();
    //        term_prime();
    //    } else {
